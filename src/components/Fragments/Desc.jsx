      ...
      <div className="bg-primary ">
        ...
        <div className=" flex items-center justify-center py-10">
          <div className="w-11/12 lg:w-[70%] flex flex-col gap-5">
            <div data-aos="fade-up" data-aos-delay="175" className=" h-[225px]  overflow-auto flex flex-row gap-3 px-3">
              {project.imageProject.map((img, index) => (
                <img key={index} src={img} alt="img" className="h-full rounded-md object-cover" />
              ))}
            </div>
