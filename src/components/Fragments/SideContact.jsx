...
const SideContact = () => {
  return (
    <div className="">
      <div className=" text-white flex flex-col fixed my-auto justify-end lg:bottom-24 lg:right-14 z-50 invisible lg:visible lg:right-8 lg:bottom-16">
      ...
      <div className="bg-transparent text-sm lg:text-base  p-5 text-white flex flex-col fixed lg:bottom-14 invisible lg:visible lg:right-16 lg:bottom-5 z-50 my-auto lg:right-24 justify-end">
