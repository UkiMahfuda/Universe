...
export const Content = () => {
  return (
    <div className="relative">
      ...
      <div className=" container items-center absolute gap-5 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex justify-evenly flex-wrap lg:flex-nowrap lg:px-24 py-5 lg:mt-0 mt-5 px-5 sm:px-10 ">
