      ...
      <div className=" container items-center absolute gap-5 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex justify-evenly flex-wrap lg:flex-nowrap lg:px-24 py-5 lg:mt-0 mt-3 px-5 sm:px-10 ">
        <div className=" lg:w-2/3">
          ...
          <div className="grid grid-cols-1 gap-3">
            <p className="text-gray montserrat text-sm sm:text-base" data-aos="fade-up" data-aos-delay="100">
            ...
            <p className="text-gray montserrat text-sm sm:text-base" data-aos="fade-up" data-aos-delay="150">
            ...
            <p className="text-gray montserrat text-sm sm:text-base" data-aos="fade-up" data-aos-delay="200" data-aos-offset="0">
            ...
            <p className="text-gray montserrat text-sm sm:text-base" data-aos="fade-up" data-aos-delay="250" data-aos-offset="-100">
