...
const Projects = () => {
  return (
    <div className="bg-primary">
      <div className="flex justify-center items-center xl:h-dvh xl:pt-0 md:pt-28 pb-28 md:pb-0  ">
        <div className="container flex flex-col items-center">
          <div className="mb-7 w-11/12 lg:w-3/4 mt-24 md:mt-0 ">
            ...
            <p className="mt-3 text-gray montserrat text-base" data-aos="fade-up" data-aos-delay="100">
