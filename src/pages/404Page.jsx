  ...
  return (
    <div className="h-dvh w-full flex flex-col justify-center items-center bg-primary">
      ...
      <button className="mt-5">
        <Link to="/" className="relative inline-block text-sm font-medium text-tesier group active:text-orange-500 focus:outline-none focus:ring">
          ...
          <span className="relative block px-8 py-3 bg-secondary rounded-md border border-current">Go Home</span>
        </Link>
      </button>
    </div>
  );
